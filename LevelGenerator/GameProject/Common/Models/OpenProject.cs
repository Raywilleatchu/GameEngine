...
namespace LevelGenerator.GameProject
{
    ...
    class OpenProject
    {
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\LevelGenerator\";
        ...
        public static void ReadProjectData()
        {
            if(File.Exists(_projectDataPath))
            {
                ...
                foreach(var project in projects)
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.gamel\icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.gamel\screenshot.png");
